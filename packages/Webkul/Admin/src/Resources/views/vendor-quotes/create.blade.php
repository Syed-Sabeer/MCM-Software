            ...
            <div class="document-form-panel rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900 dark:text-white">
                ...
                <div class="mt-4 grid gap-4" style="grid-template-columns: repeat(2, minmax(0, 1fr));">
                    <div>
                        ...
                        <input type="date" name="first_delivery_date" value="{{ old('first_delivery_date', $defaultExpectedReceiveDate) }}" class="custom-input">
                    </div>
                    <div>
                        <label class="mb-1 block text-sm font-medium">Last Delivery</label>
                        <input type="date" name="last_delivery_date" value="{{ old('last_delivery_date', $defaultExpectedReceiveDate) }}" class="custom-input">
                    </div>
                </div>
            ...
            <div class="document-form-panel rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900 dark:text-white">
                    ...
                    <tbody>
                        @foreach ($prefillItems as $index => $item)
                            <tr>
                                ...
                                <td class="py-2"><input type="number" step="0.0001" min="0.0001" name="items[{{ $index }}][ordered_quantity]" value="{{ $item['ordered_quantity'] ?? 1 }}" class="custom-input item-qty" oninput="window.calculateVendorQuoteTotals()"></td>
                                ...
                                <td class="py-2"><input type="number" step="0.01" min="0" name="items[{{ $index }}][price]" value="{{ $item['price'] ?? 0 }}" class="custom-input item-price" oninput="window.calculateVendorQuoteTotals()"></td>
                ...
                <div class="mt-4 flex justify-end">
                    <div class="document-form-summary-box is-wide grid gap-4 rounded-lg bg-gray-100 p-5 text-sm dark:bg-gray-950 dark:text-white" style="max-width: 100%;">
                        <div class="flex items-center justify-between gap-x-5"><span>Sub Total</span><input type="hidden" name="subtotal" id="vendor-quote-subtotal-input" value="0"><p class="text-base font-semibold" id="vendor-quote-subtotal">0.00</p></div>
                        ...
                        <div class="flex items-center justify-between gap-x-5"><span>Additional Charges</span><input type="hidden" name="sales_tax_amount" id="vendor-quote-sales-tax-amount-input" value="0"><input type="hidden" name="freight" id="vendor-quote-freight-input" value="0"><p class="text-base font-semibold" id="vendor-quote-charges-total">0.00</p></div>
                        <div class="flex items-center justify-between gap-x-5 border-t border-gray-200 pt-3 text-base font-semibold dark:border-gray-800"><span>Grand Total</span><input type="hidden" name="grand_total" id="vendor-quote-grand-total-input" value="0"><p id="vendor-quote-grand-total">0.00</p></div>
                    </div>
                </div>
            </div>
