                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control type="text" name="sku" id="item_code" :value="old('sku', $product->sku)" />
                            ...
                            <x-admin::form.control-group>
                                ...
                                <x-admin::form.control-group.control type="text" name="internal_code" id="internal_code" :value="old('internal_code', $product->internal_code)" />
                        ...
                        <div class="mt-4 rounded border border-gray-200 p-3 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <x-admin::form.control-group class="!mb-0">
                                    ...
                                    <x-admin::form.control-group.control type="number" step="0.0001" min="0" name="cost_price" :value="old('cost_price', $product->cost_price)" />
                                ...
                                <x-admin::form.control-group class="!mb-0">
                                    ...
                                    <x-admin::form.control-group.control type="number" step="0.0001" min="0" name="selling_price" :value="old('selling_price', $product->selling_price ?? $product->price)" />
        ...
        <script>
            function initProductEditForm() {
                ...
                function addExistingOtherImageRow(image) {
                    ...
                    var row = document.createElement('div');
                    row.className = 'existing-other-image-row grid grid-cols-1 gap-2 rounded border border-gray-200 p-2 md:grid-cols-[80px_1fr_180px_1fr_auto] dark:border-gray-700';
                    ...
                    row.innerHTML = ''
                        ...
                        + '</select>'
                        + '<span class="truncate text-xs text-gray-500 dark:text-gray-400">' + escapeHtml(image.original_name || '') + '</span>'
                        + '<button type="button" class="remove-existing-other-image secondary-button">Remove</button>';
