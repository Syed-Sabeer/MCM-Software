<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.products.categories.create')
    </x-slot>
        ...
        <div class="rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            <div class="flex flex-col gap-2">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-bold dark:text-white">@lang('admin::app.products.categories.create')</span>
                </div>
            </div>
        </div>

        <x-admin::form :action="route('admin.product_categories.store')" method="POST">
            <div class="box-shadow rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="flex gap-2 mt-4">
                    <button type="submit" class="primary-button">@lang('admin::app.products.categories.create')</button>
