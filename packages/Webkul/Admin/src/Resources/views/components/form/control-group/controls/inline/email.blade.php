                ...
                >
                    <span class="cursor-pointer truncate rounded">
                        @{{ 
                            valueLabel 
                                ? valueLabel 
                                : emails.map(item => `${item.value}(${item.label})`).join(', ').length > 20
                                    ? emails.map(item => `${item.value}(${item.label})`).join(', ').substring(0, 20) + '...'
                                    : emails.map(item => `${item.value}(${item.label})`).join(', ')
                        }}
                    </span>
                    ...
                    <div
                        ...
                        v-if="emails.map(item => `${item.value}(${item.label})`).join(', ').length > 20"
                    >
