    ...
    >
        <div class="flex flex-col gap-4">
            <div class="document-form-toolbar flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                ...
                <button type="submit" class="primary-button" data-loading-submit data-loading-text="Updating...">
    ...
    @pushOnce('scripts')
            ...
            <div class="document-form-panel quote-create-form-panel box-shadow flex flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                ...
                <div class="quote-meta-stack">
                    ...
                    <div class="document-form-row-6 quote-meta-block" style="display: grid !important; grid-template-columns: repeat(6, minmax(0, 1fr)) !important; gap: 16px; margin-top: 16px;">
                        ...
                        <x-admin::form.control-group class="!mb-0"><x-admin::form.control-group.label>ETD</x-admin::form.control-group.label><input type="date" name="etd" value="{{ old('etd', $quote->etd?->format('Y-m-d')) }}" class="custom-input"><x-admin::form.control-group.error control-name="etd" /></x-admin::form.control-group>
                        <x-admin::form.control-group class="!mb-0"><x-admin::form.control-group.label>ETA</x-admin::form.control-group.label><input type="date" name="eta" value="{{ old('eta', $quote->eta?->format('Y-m-d')) }}" class="custom-input"><x-admin::form.control-group.error control-name="eta" /></x-admin::form.control-group>
                    </div>
                ...
                <div class="document-form-items mt-2 flex flex-col gap-4" id="quote-items">
                    ...
                    <v-quote-item-list :errors="errors" :organization-id="selectedOrganizationId" :organization-name="customerName" :companies="customers" :initial-products="initialProducts" :initial-charges='@json($initialQuoteCharges)'></v-quote-item-list>
                </div>
        ...
        <script type="module">
            app.component('v-quote', {
                ...
                props: ['errors', 'customers', 'initialProducts', 'initialCustomerId', 'initialBillingAddress', 'initialShippingAddress'],
                data() {
                    return {
                        customerName: '',
                        customerSearchTerm: '',
            ...
            app.component('v-quote-product-lookup', {
                ...
                methods: {
                    ...
                    closeQuickCreate() {
                        if (! this.isCreatingProduct) this.$refs.quickProductModal.close();
                    },
